...
import cls from './TikTokIcon.module.scss'

export const TikTok = memo((props: SVGProps<SVGSVGElement>) => {
  return (
    <div className={classNames(cls.tikTokIcon, {}, [props.className])}>
      <svg xmlns="http://www.w3.org/2000/svg" xmlnsXlink="http://www.w3.org/1999/xlink" version="1.1" width="256" height="256" viewBox="0 0 256 256" xmlSpace="preserve">
        ...
        >
          <path
            ...
            strokeLinecap="round"
            className={cls.turquoise}
          />
          <path
            d="M 36.203 35.438 v -3.51 c -1.218 -0.173 -2.447 -0.262 -3.677 -0.268 c -15.047 0 -27.289 12.244 -27.289 27.291 c 0 9.23 4.613 17.401 11.65 22.342 c -4.712 -5.039 -7.332 -11.681 -7.328 -18.58 C 9.559 47.88 21.453 35.784 36.203 35.438"
            transform=" matrix(1 0 0 1 0 0) "
            strokeLinecap="round"
            className={cls.lightGray}
          />
          <path
